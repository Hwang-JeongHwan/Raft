...
//var random1 = Random.getRandom(100,500);//랜덤 시간후 전송하기 위한 변수
var random1 = 145.54859282350003;
...
client.on('message', (msg, rinfo) => {
  ...
  // }
  if(i.id == 'app'&&i.value%10==0 &&orderer_parse.state == 'leader'){
    orderer_parse.state = 'follower'; // 오더러를 죽이고
   ...
   if(i.candidate == 'orderer1'&& orderer_parse.state!='leader'&& orderer_parse.rejoin !='yes' &&orderer_parse.state !='rejoin'&&orderer_parse.state != 'dead'){
    ...
    if(i.leader == 'noleader'){
        const timer = async () => {
          ...
          //  var random = Random.getRandom(500,1500);
